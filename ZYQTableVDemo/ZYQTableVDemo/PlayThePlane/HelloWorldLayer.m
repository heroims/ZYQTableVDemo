...
//  Copyright Zhao Yiqi 2013年. All rights reserved.
//
...
- (void) gameOver {
    ...
    CCMenuItemFont *gameOverItem1 = [CCMenuItemFont itemWithString:@"restart" target:self selector:@selector(restart)];
    [gameOverItem1 setFontName:@"MarkerFelt-Thin"];
    [gameOverItem1 setFontSize:30];
    
    CCMenuItemFont *gameOverItem2 = [CCMenuItemFont itemWithString:@"close" target:self selector:@selector(close)];
    [gameOverItem2 setFontName:@"MarkerFelt-Thin"];
    [gameOverItem2 setFontSize:30];

    restartMenu = [CCMenu menuWithItems:gameOverItem1, nil];
    [restartMenu setPosition:ccp(160, 200)];
    [self addChild:restartMenu z:4];
    
    closeMenu = [CCMenu menuWithItems:gameOverItem2, nil];
    [closeMenu setPosition:ccp(160, 240)];
    [self addChild:closeMenu z:4];
...
-(void)close{
    ...
    newwindow.rootViewController=[[[ViewController alloc] init] autorelease];
